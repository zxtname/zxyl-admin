	...
	<div>
		...
		<div class="container">
			<div class="handle-box">
				...
				<el-input v-model="query.videoName" placeholder="视频名" class="handle-input mr10"></el-input>
		...
		<el-dialog title="编辑" :visible.sync="editVisible" width="70%">
			...
			<el-form ref="formsRef" :model="form" label-width="70px">
				...
				<el-upload class="upload-demo" ref="upload" drag :action="this.loadURL.videoUrl" :on-success="handleVideoSuccess" :limit="1">
					...
					<div class="el-upload__tip" slot="tip">格式最好时MP4</div>
				</el-upload>
			</el-form>
		...
		<el-dialog title="添加视频" :visible.sync="addVisible" width="50%">
			...
			<el-form ref="addFormRef" :model="addForm" :rules="addFormRules" label-width="80px">
				<el-row :gutter="20" style="margin-bottom: 15px;">					
					<el-col :span="10">
						<el-select v-model="addForm.crouserId" placeholder="请选择课程" style="width:300px;">
			...
			<el-upload class="upload-demo" ref="addUpload" drag :action="this.loadURL.videoUrl" :on-success="addVideoSuccess" :limit="1">
				...
				<div class="el-upload__tip" slot="tip">视频格式最好为MP4</div>
			</el-upload>
			<span slot="footer" class="dialog-footer">
...
import {GetVideo,GetCourseInfo} from '@/api/teacher.js'
export default {
	data() {
		return {
			options: [],
	...
	methods: {
		async searchCourse() {			
			let res = await GetCourseInfo(this.queryCourse);
			// console.log(res);
		...
		async getData() {
			...
			// } else {
				const res = await GetVideo(this.query);
				if (res.code !== 1) {
